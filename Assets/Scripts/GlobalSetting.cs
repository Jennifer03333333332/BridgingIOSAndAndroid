...
public static class GlobalSetting
{
    ...
    public static Dictionary<MeshType, ModelsSetting> spots_dictionary = new Dictionary<MeshType, ModelsSetting> {
        ...
        {MeshType.Barge0, new ModelsSetting(Spots.one, new Vector3(0f, 0f, 0f), new Vector3(0, 0, 0), 2, 1f, Quaternion.AngleAxis(45f, Vector3.forward))},
        ...
        {MeshType.Furnaces2, new ModelsSetting(Spots.three, new Vector3(0, -0.5f, 10), new Vector3(0, 0, 0), 1f, 1f, Quaternion.AngleAxis(45f, Vector3.up))},
    };
}
