...
public static class GlobalSetting
{
    ...
    public static Dictionary<MeshType, ModelsSetting> spots_dictionary = new Dictionary<MeshType, ModelsSetting> {
        ...
        {MeshType.Barge0, new ModelsSetting(Spots.one, new Vector3(0f, 0f, 200f), new Vector3(0, 0, 0), 1, 1f, Quaternion.AngleAxis(45f, Vector3.forward))},
        ...
        {MeshType.Barge2, new ModelsSetting(Spots.three, new Vector3(0f, 0f, 4000f), new Vector3(0, 0, 0), 1, 1f, Quaternion.AngleAxis(45f, Vector3.up))},
